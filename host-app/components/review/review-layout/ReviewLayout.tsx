...
export function ReviewLayout({
  ...
  accept: ReactNode
  /**
   * What stands in for the accept bar when there is nothing to accept WITH.
   *
   * Its own prop rather than something the caller passes as `accept`, because `accept` is a declared
   * SLOT: the region wraps whatever it is given in the accept-bar island, and a token form wrapped in
   * that island would be the wrong component mounted under a slot that names another. Two props, and
